...
public class Container {
    ...
    public static final String DEFAULT_ENV_VARS = "ZINK_DESCRIPTORS=lazy ZINK_DEBUG=compact MESA_SHADER_CACHE_DISABLE=false MESA_SHADER_CACHE_MAX_SIZE=512MB mesa_glthread=true WINEESYNC=1 DXVK_HUD=0 BOX64_MMAP32=1 BOX64_DYNAREC_WEAKBARRIER=0 WINE_DISABLE_FULLSCREEN_HACK=1";
