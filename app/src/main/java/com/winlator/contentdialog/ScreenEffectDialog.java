...
public class ScreenEffectDialog extends ContentDialog {
    ...
    public ScreenEffectDialog(XServerDisplayActivity activity) {
        ...
        ///
        //findViewById(R.id.BTReset).setVisibility(View.VISIBLE);
        //findViewById(R.id.BTReset).setOnClickListener(v -> resetSettings());
        ...
        findViewById(R.id.BTConfirm).setOnClickListener(v -> {
            ...
            applyEffects(renderer, fxaaEffect, crtEffect, toonEffect, ntscEffect);
    ...
    private void addFrameGenerationView() {
        if (activity.frameGenerationView == null) {
            ...
            activity.frameGenerationView.setFrameGenerationCallback((value) -> {
                FrameGenerationEffect frameGenerationEffect = (FrameGenerationEffect) currentRenderer.getEffectComposer().getEffect(FrameGenerationEffect.class);
...
//        Context context = textView.getContext();
    ...
    public void applyEffects(GLRenderer renderer, FXAAEffect fxaaEffect, CRTEffect crtEffect, ToonEffect toonEffect, NTSCCombinedEffect ntscEffect) {
    ...
    public void applyFrameGenerationEffect(GLRenderer renderer, FrameGenerationEffect frameGenerationEffect, Boolean enableFrameGenerationEffect) {
        ...
        if (enableFrameGenerationEffect) {
            if (frameGenerationEffect == null) {
                ...
                frameGenerationEffect = new FrameGenerationEffect(generationMode, fpsMultiplier, apiMode, usePostProcessing, blendModeAuto, blendScale);
